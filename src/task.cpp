...
// int subtask_DELIVER_CHECK::setSubtask(Json::Value js, map<string,ros::Publisher*> mPubs){
//     subtaskBase::setSubtask(js, mPubs);    

// }
// int subtask_DELIVER_CHECK::invokeSubtask(){
//     subtaskBase::invokeSubtask();
...
// int subtask_DELIVER_CHECK::callback_subtask(Json::Value js){
//    if (status==-1)
//         return -1;
//     string msgfrom  = js["type"].asString(); 
//     string delStatus = js["status"].asString();
//     if (msgfrom=="deliver_check") {
//         // cout << "deliver_check message arrived" << endl;
//         status = 0;
//         cout << "subtask_DELIVER_CHECK::callback_subtask(Json::Value js) : arrived"  << endl;

//         // decide action according to the deliver check result 
//         // if(delStatus.compare("success") == 0){ // modify
            
//         // }
//         // else if(delStatus.compare("fail") == 0){
            
//         // }

//     }
//     else {
//         cout << "subtask_DELIVER_CHECK::callback_subtask::::ignore message" << endl;
//     }
//     return status;
// }
